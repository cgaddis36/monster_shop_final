...
RSpec.describe Cart do
  describe 'Instance Methods' do
    before :each do
      ...
      @discount_1 = @brian.discounts.create!(name: "Discount 1", desired_quantity: 2, percentage: "20")
      @discount_2 = @brian.discounts.create!(name: "Discount 2", desired_quantity: 4, percentage: "25")
