...
RSpec.describe 'Merchant Bulk Discounts Page' do
  before(:each) do
    ...
    @item_3 = @merchant_2.items.create!(name: 'Tractor', description: "Let me take a ride on my big green tractor", price: 50, image: 'https://target.scene7.com/is/image/Target/GUEST_a8cb0bab-7915-4ca4-b38a-8b13324f5243?wid=325&hei=325&qlt=80&fmt=webp', active: true, inventory: 6 )
  ...
  it "on the bulk discounts page I have the option to add discounts based on Item quantity to the items in my shop." do
    ...
    within "#item-#{@item_2.id}" do
      expect(page).to have_content("Subtotal: $600.00")
    end
