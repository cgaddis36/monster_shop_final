...
## Bulk Discount
  ...
  User Story 1
  - As a merchant employee, when I visit the merchant's Dashboard '/merchant',
  - I see a link to add discounts to items
  - This link redirects me to a new page, '/merchant/items/discounts'

  User Story 2
  - As a merchant employee, when I visit the merchant items discounts page, '/merchant/items/discounts'
  - I see a list of all of the items in the inventory for this merchant and no other merchants items
  - I see two fields to enter in a % based discount;
    1) The minimum amount of items needed to get the bulk discount
    2) % discount rate they want to implement
  - Merchants can have multiple bulk discount rates for their items
